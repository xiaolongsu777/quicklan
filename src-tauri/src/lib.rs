...
use commands::{
    ...
    get_game_room_state, get_library_settings, get_local_ezmovie_stream, get_network_status,
    get_settings, get_transfer, get_transfers, hide_watch_webview, import_local_ezmovie_stream,
    install_update, join_game_room, join_watch_room, leave_game_room, leave_watch_room,
    list_chat_messages, list_chat_rooms, list_devices, list_game_rooms, list_my_shares,
    list_shared_resources, list_watch_chat_messages, list_watch_rooms, open_path_location,
    reject_transfer, remove_share, remove_transfer_record, request_gomoku_move,
    request_gomoku_restart, send_chat_message, send_files, send_watch_chat_message,
    set_watch_webview_bounds, submit_watch_room_url, surrender_gomoku, update_device_note,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_local_ezmovie_stream,
            create_watch_room,
            join_watch_room,
            leave_watch_room,
            end_watch_room,
            submit_watch_room_url,
            import_local_ezmovie_stream,
